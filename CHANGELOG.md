...
- You can now toggle the `terminal.integrated.inheritEnv` VSCode setting directly for the Roo Vibecoding settings (thanks @KJ7LNW)
...
- Fix a nasty bug that would cause Roo Vibecoding to hang, particularly in orchestrator mode
...
- Simplify and streamline Roo Vibecoding's quick actions
- Allow Roo Vibecoding settings to be imported from the welcome screen (thanks @julionav)
...
- Focus Roo Vibecoding in the sidebar when running tasks in the sidebar via the API
- Improve subtasks UI
...
- Add command to focus Roo Vibecoding input field (thanks @axkirillov!)
...
- Allow processes to access the Roo Vibecoding API via a unix socket
...
- Add an activation command that other extensions can use to interface with Roo Vibecoding (thanks @gtaylor!)
...
- Internationalize Roo Vibecoding into Catalan, German, Spanish, French, Hindi, Italian, Japanese, Korean, Polish, Portuguese, Turkish, Vietnamese, Simplified Chinese, and Traditional Chinese (thanks @feifei325!)
...
- Add opt-in telemetry to help us improve Roo Vibecoding faster (thanks Cline!)
...
- Add support for a .rooignore to prevent Roo Vibecoding from read/writing certain files, with a setting to also exclude them from search/lists (thanks Cline!)
...
- Add a new “Human Relay” provider that allows you to manually copy information to a Web AI when needed, and then paste the AI's response back into Roo Vibecoding (thanks @NyxJae)!
...
- Introducing Roo Vibecoding 3.7, with support for the new Claude Sonnet 3.7. Because who cares about skipping version numbers anymore? Thanks @lupuletic and @cte for the PRs!
...
- New Roo Vibecoding community Discord at https://roocode.com/discord!
...
- **Name Change From Roo Cline to Roo Vibecoding:** We're excited to announce our new name! After growing beyond 50,000 installations, we've rebranded from Roo Cline to Roo Vibecoding to better reflect our identity as we chart our own course.

- **Custom Modes:** Create your own personas for Roo Vibecoding! While our built-in modes (Code, Architect, Ask) are still here, you can now shape entirely new ones:
...
- This release adds chat modes! Now you can ask Roo Vibecoding questions about system architecture or the codebase without immediately jumping into writing code. You can even assign different API configuration profiles to each mode if you prefer to use different models for thinking vs coding. Would love feedback in the new Roo Vibecoding Reddit! https://www.reddit.com/r/RooCode
