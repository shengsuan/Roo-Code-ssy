...
У Roo Code Pro есть четкая дорожная карта развития, определяющая наши приоритеты и будущее направление. Понимание дорожной карты поможет тебе:
...
### 3. Присоединяйся к сообществу Roo Code Pro

Вступление в сообщество Roo Code Pro — отличный способ начать:

- **Основной способ**:
    1.  Присоединяйся к [сообществу Roo Code Pro в Discord](https://discord.gg/roocode).
...
- **Good First Issues**: Ознакомься с разделом "Issue [Unassigned]" в нашем [проекте Roo Code Pro Issues](https://github.com/orgs/RooVetGit/projects/1) на GitHub.
- **Документация**: Хотя этот `CONTRIBUTING.md` — основной гид по вкладу в код, если хочешь внести вклад в другую документацию (например, руководства пользователя или API), смотри [репозиторий Roo Code Pro Docs](https://github.com/RooVetGit/Roo-Code-Docs) или спроси в сообществе Discord.
...
4.  **Отладка расширения**: Нажми `F5` в VS Code (или **Run** → **Start Debugging**), чтобы открыть новое окно Extension Development Host с Roo Code Pro.
