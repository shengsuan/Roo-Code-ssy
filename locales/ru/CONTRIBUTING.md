...
- [I. Перед тем как внести вклад](#i-перед-тем-как-внести-вклад)
    ...
    - [3. Присоединяйся к сообществу Cline Pro](#3-присоединяйся-к-сообществу-roo-code)
...
У Cline Pro есть четкая дорожная карта развития, определяющая наши приоритеты и будущее направление. Понимание дорожной карты поможет тебе:
...
### 3. Присоединяйся к сообществу Cline Pro

Вступление в сообщество Cline Pro — отличный способ начать:

- **Основной способ**:
    1.  Присоединяйся к [сообществу Cline Pro в Discord](https://discord.gg/roocode).
...
- **Good First Issues**: Ознакомься с разделом "Issue [Unassigned]" в нашем [проекте Cline Pro Issues](https://github.com/orgs/RooVetGit/projects/1) на GitHub.
- **Документация**: Хотя этот `CONTRIBUTING.md` — основной гид по вкладу в код, если хочешь внести вклад в другую документацию (например, руководства пользователя или API), смотри [репозиторий Cline Pro Docs](https://github.com/RooVetGit/Roo-Code-Docs) или спроси в сообществе Discord.
...
4.  **Отладка расширения**: Нажми `F5` в VS Code (или **Run** → **Start Debugging**), чтобы открыть новое окно Extension Development Host с Cline Pro.
