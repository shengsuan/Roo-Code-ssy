...
**NOTE:** To ensure that the `shengsuan-cloud.roo-vibecoding` extension is activated before your extension, add it to the `extensionDependencies` in your `package.json`:

```json
"extensionDependencies": ["shengsuan-cloud.roo-vibecoding"]
```
