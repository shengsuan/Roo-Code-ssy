...
build_extension() {
  echo "🔨 Building the Cline Pro extension..."
  cd ..
  mkdir -p bin
...
echo -n "🗄️ Syncing Cline Pro evals database... "
...
read -p "💻 Do you want to build a new version of the Cline Pro extension? [currently $current_version] (y/N): " build_extension
