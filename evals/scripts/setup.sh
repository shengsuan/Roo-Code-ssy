...
build_extension() {
  echo "🔨 Building the Roo Code Pro extension..."
  cd ..
  mkdir -p bin
...
echo -n "🗄️ Syncing Roo Code Pro evals database... "
...
read -p "💻 Do you want to build a new version of the Roo Code Pro extension? [currently $current_version] (y/N): " build_extension
