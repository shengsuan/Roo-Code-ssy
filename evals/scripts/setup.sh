...
build_extension() {
  echo "🔨 Building the Roo Vibecoding extension..."
  cd ..
  mkdir -p bin
...
echo -n "🗄️ Syncing Roo Vibecoding evals database... "
...
read -p "💻 Do you want to build a new version of the Roo Vibecoding extension? [currently $current_version] (y/N): " build_extension
